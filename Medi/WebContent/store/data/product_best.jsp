...
for (int i = 0; i < vResult.size(); i++) {
    ...
    %>
    <li><a href="javascript:productDetail('<%=product.getPnum()%>')"><img src="store/data/imgs/<%=product.getImage()%>" width="245px" height="235px">
    <br><span class="p_name"><%=product.getPname()%></span>
    <br><span class="p_price"><%=UtilMgr.intFormat(product.getPrice())%>$</span></a></li>
<%
}
%>
    </ul>
