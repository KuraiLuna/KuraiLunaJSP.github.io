...
<head>
	...
	<link href="css/cartoon_write.css" rel="stylesheet" type="text/css">
...
<body >
	<div id="wrap">
		...
		<section id="contents">
			<div id= "cartoonbox" align="center">
				<form name="writeFrm" method="post" action="cartoonProc.jsp"  enctype="multipart/form-data">
				
				
				 	<table>
				 	<!--  <div class= "cartoonbox" align="center">-->
				 	<h3 id="title" style="color:#37b7fe ">Cartoon</h3>
					<!--  <div id="titlebox">
