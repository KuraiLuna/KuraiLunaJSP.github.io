...
<body >
	<div id="wrap">
		<%@ include file="cartoon_write.jsp" %>	
			...
			<div id="titlebox">
				...
				%>
					...
					<form method="get" name="cartoonFrm" action="reply2Proc.jsp" onkeydown="return enter(event)">
	...
	<form name="rDeleteFrm" method="post" action="reply2DeleteProc.jsp">
	...
	<form name="flike" method="post" action="likeProc2.jsp">
		<input type="hidden" name="id" value="<%=id%>">
		<input type="hidden" name="snum">
		<input type="hidden" name="mode">
	</form>
	<form method="post" name="sFrm" action="reply2Proc.jsp">
		<input type="hidden" name="comment">
		<input type="hidden" name="pos">
	</form>
</body>
